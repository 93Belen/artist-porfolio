export default function Loading() {
    ...
    return (
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" style={{margin: "auto", backgroundImage: "none", display: "block", shapeRendering: "auto"}} width="211px" height="211px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
