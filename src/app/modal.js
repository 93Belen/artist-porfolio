    ...
    return (
        <div id='modal' className='h-[100vh] w-screen absolute z-10  md:rounded-xl hidden box-border'>
            <div className='grid p-8 pb-10 h-fit sm:w-full grid-cols-1 md:grid-cols-2 md:grid-rows-[5%_40%_55%] gap-4 md:w-4/5 m-auto md:rounded-xl backdrop-blur-2xl'>
                <button onClick={closeModal} className='text-white md:col-start-2 md:self-start md:justify-self-end row-start-1 md:hover:rotate-[360deg] md:active:rotate-[360deg] duration-700'><svg id='close-modal-svg' width="25" height="100%" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='text-white p-4'>
                    ...
                    <button className='text-2xl text-white p-1 bg-orange-400 h-[63px] m-2 md:m-4 w-[135px] md:bg-orange-400 rounded-xl hover:bg-orange-300 md:hover:text-black'>Buy</button>
                </div>
