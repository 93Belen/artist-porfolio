...
export default function Cart(){
    ...
    return (
    <div style={{animation: 'floating 3s ease-in-out infinite', display: `${display}` }} className="h-[60px] w-[60px] sticky rounded-full bg-orange-400 left-[90vw] top-[5vh] z-10 p-1">
