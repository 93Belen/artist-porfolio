...
export default function Modal(){
    ...
    return (
        <div id='modal' className='h-[80vh] w-screen absolute z-10  md:rounded-xl hidden'>
            <div className='grid p-8 min-h-fit sm:w-full md:grid-cols-2 md:grid-rows-[5%_60%_35%] gap-4 md:w-4/5 m-auto md:rounded-xl bg-white'>
                <button onClick={closeModal} className='text-black md:col-start-2 md:self-start md:justify-self-end'><svg id='close-modal-svg' width="25" height="100%" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
